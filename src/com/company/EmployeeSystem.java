...
//        return -1;
//    }
//    // attempting to create a method to modify entries
//    public boolean modifyAccountant(String forename, String surname, String birthDate, String qualification, boolean chartered){
//        if (findAccountantInt(forename, surname)>= 0){
//            int accountantPosition = findAccountantInt(forename, surname);
//            accountantList.set(accountantPosition, new Accountant(forename, surname, birthDate, qualification, chartered));
//            return true;
//        }
//        return false;
//    }
